<div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between mb-10">
    ...
    <div>
        ...
        <p class="text-gray-500 mt-2">
            Tambahkan foto baru ke galeri Desa Bungur.
        </p>
    </div>
...
<div class="bg-white rounded-3xl shadow-sm p-8 mb-32 max-w-3xl">
    <form action="/user/photo/add" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="caption" name="caption"
                value="<?= htmlspecialchars($model['old']['caption'] ?? '') ?>"
            ...
            <?php if (isset($model['errors']['caption'])): ?>
                <p class="text-red-500 text-sm mt-1">
                    <?= htmlspecialchars($model['errors']['caption']) ?>
                </p>
            <?php endif; ?>
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" id="location" name="location"
                value="<?= htmlspecialchars($model['old']['location'] ?? '') ?>"
        ...
        <div class="mb-6">
            ...
            <?php if (isset($model['errors']['image'])): ?>
                <p class="text-red-500 text-sm mt-1">
                    <?= htmlspecialchars($model['errors']['image']) ?>
                </p>
            <?php endif; ?>
        </div>
