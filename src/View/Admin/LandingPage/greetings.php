    ...
    <div class="p-4 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center border-b border-slate-200">
        ...
        <div class="flex items-center gap-3 w-full sm:w-auto">
            ...
            <div class="relative flex-1 sm:flex-none">
                ...
                <input id="searchInput" type="text" placeholder="Cari sambutan..."
            ...
            <!-- ADD -->
            <a href="/admin/landing/greetings/add"
...
<script>
    ...
    // DATA FROM PHP
    // ==========================================================
    const allData = <?= json_encode($model['greetings'] ?? []) ?>;
    ...
    function PhotoRenderer(params) {
        if (params.value) {
            return `<img src="/uploads/greeting/${encodeURIComponent(params.value)}" 
                         class="photo-thumb" 
                         alt="Photo"
                         onerror="this.src='https://ui-avatars.com/api/?name=User&size=40&background=15803d&color=fff'">`;
        }
        return `<img src="https://ui-avatars.com/api/?name=User&size=40&background=15803d&color=fff" 
                     class="photo-thumb" 
                     alt="Photo">`;
    }
    ...
    function ActionRenderer(params) {
        ...
        return `
            <div class="flex items-center gap-2">
                <a href="/admin/landing/greetings/edit/${id}" 
    ...
    const columnDefs = [
        ...
        { headerName: "Foto", field: "image", cellRenderer: PhotoRenderer, width: 70, minWidth: 70, maxWidth: 70, resizable: false },
    ...
    const gridOptions = {
        ...
        overlayNoRowsTemplate: `
            <div class="ag-overlay-no-rows-center flex flex-col items-center gap-2 text-slate-400">
                <span>Belum ada sambutan</span>
                <a href="/admin/landing/greetings/add" class="text-primary hover:underline text-sm">Tambah sambutan</a>
            </div>
        `
    };
...
<div id="deleteConfirmModal" class="fixed inset-0 z-[99999] hidden">
    ...
    <div class="relative z-10 flex items-center justify-center min-h-screen p-6">
        <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden animate-[fadeIn_.2s_ease]">
            ...
            <form action="/admin/landing/greetings/delete" method="POST" class="flex gap-3 p-6 pt-0">
