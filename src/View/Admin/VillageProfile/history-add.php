...
<div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
    <div>
        ...
        <p class="mt-2 text-slate-500 max-w-2xl text-sm lg:text-base leading-relaxed">
            Tambahkan timeline sejarah baru untuk ditampilkan di website Desa Bungur.
        </p>
    </div>
</div>
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden max-w-3xl">
    <form action="/admin/profile/histories/add" method="POST" enctype="multipart/form-data">
        <div class="p-6 space-y-6">

            <!-- Tahun -->
            <div>
                <label class="block text-sm font-medium text-slate-700 mb-1">Tahun <span class="text-red-500">*</span></label>
                <input type="number" name="year" value="<?= htmlspecialchars($model['old']['year'] ?? '') ?>"
            ...
            <div>
                ...
                <textarea name="description" rows="6"
                    ...
                    placeholder="Ceritakan peristiwa sejarah secara lengkap..." required><?= htmlspecialchars($model['old']['description'] ?? '') ?></textarea>
            ...
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">Upload gambar untuk ilustrasi (JPG, PNG, WEBP, GIF) - Maksimal 2MB</p>
