...
<body class="bg-slate-50 text-slate-600 font-sans antialiased overflow-x-hidden">
    ...
    =========================================================== -->
            ...
            <nav class="flex-1 px-4 py-6 overflow-y-auto">
                ...
                <a href="/admin/dashboard" class="group flex items-center gap-3 px-4 py-3 rounded-xl
                ...
                <a href="/admin/users" class="group flex items-center gap-3 px-4 py-3 rounded-xl
                    <?= $model['current'] === 'users'
                        ? 'bg-primary/10 text-primary font-semibold'
                        : 'text-gray-600 hover:bg-gray-100 hover:text-primary' ?>">
