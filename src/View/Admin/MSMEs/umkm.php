...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-6">
    ...
    <div class="p-4 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center border-b border-slate-200">
        <div class="flex items-center gap-3">
            ...
            <span class="text-xs font-medium text-slate-500 bg-slate-100 px-2.5 py-0.5 rounded-full" id="totalBadge"><?= count($model['umkms'] ?? []) ?></span>
        </div>
...
<style>
    ...
    .category-kuliner { background: #FEF3C7; color: #92400E; }
    .category-kerajinan { background: #EDE9FE; color: #5B21B6; }
    .category-kesehatan { background: #DCFCE7; color: #166534; }
    .category-pertanian { background: #D1FAE5; color: #065F46; }
    .category-peternakan { background: #DBEAFE; color: #1E40AF; }
    .category-jasa { background: #E0E7FF; color: #3730A3; }
